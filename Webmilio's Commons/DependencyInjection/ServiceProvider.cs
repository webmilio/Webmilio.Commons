...
namespace Webmilio.Commons.DependencyInjection
{
    public class ServiceProvider : IServiceProvider
    {
        ...
        public ServiceProvider(bool mapServiceAttribute, params ServiceProvider[] parents)
        {
            ...
            AppDomain.CurrentDomain.GetAssemblies().Do(a => a.DefinedTypes.Concrete().Do(t =>
            {
        ...
        public ServiceProvider AddScoped<T>() => AddScoped(typeof(T), null);
        public ServiceProvider AddScoped<T>(Func<ServiceProvider, T> factory) => AddScoped(typeof(T), provider => factory(provider));

        public ServiceProvider AddScoped(Type serviceType) => AddScoped(serviceType, null);
        public ServiceProvider AddScoped(Type serviceType, Func<ServiceProvider, object> factory)
        {
            _factories.Add(serviceType, factory);
